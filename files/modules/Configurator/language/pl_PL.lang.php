...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_MAILMERGE_DESC' => 'Ta flaga powinny być odznaczona tylko wtedy, gdy masz Plugin SuiteCRM do Microsoft&reg; Word&reg;.',
	...
	'LBL_SKYPEOUT_ON_DESC' => 'Klikając na numer telefonu pozwala na połącznie z użyciem SkypeOut&reg;.. Aby skorzystać z tej funkcji numer musi być podany odpowienim formacie: "+"  "Kod Kraju" "Numer".',
    ...
    'CURRENT_LOGO_HELP'=>'To logo jest wyświetlone w lewym górnym rogu aplikacji SuiteCRM.',
    ...
    'LBL_LDAP_ADMIN_USER_DESC'=>'Używane do wyszukiwania użytkownika SuiteCRM. [Moze wymagać pełnej nazwy]<br>Jeśli nie zostanie podane - powiąże anonimowo].',
...
// Wizard
    ...
    'LBL_WIZARD_SYSTEM_DESC' => 'Podaj nazwę twojej organizacji i logo w celu budowania marki SuiteCRM.',
    'LBL_WIZARD_LOCALE_DESC' => 'Określ, jak chcesz aby dane w aplikacji SuiteCRM były wyświetlane, na podstawie twojego położenia geograficznego. Ustawienia podane tutaj będą ustawieniami domyślnymi. Użytkownicy będą mogli ustawić swoje własne preferencje.',
	...
	'LBL_YAHOO_MAIL' => 'Yahoo Mail Logo' /*for 508 compliance fix*/,
