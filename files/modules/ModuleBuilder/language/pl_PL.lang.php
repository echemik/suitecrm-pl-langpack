...
$mod_strings = array(
    ...
    'assistantHelp' => array(
        ...
        'module' => array(
            'somemodules' => "Gdy tworzona paczka zawiera już co najmniej jeden moduł, możesz <b>Zamieścić</b> go, jako paczkę w instancji SuiteCRM, lub <b>Publikować</b> ją jako pakiet do zainstalowania w tej, lub innej instacji, używając <b>Instalator modułów</b>.<br/><br/>Aby zainstalować paczkę bezpośrednio w Twojej instancji SuiteCRM, kliknij <b>Zamieść</b>.<br><br>Aby utworzyć paczkę, możliwą do zainstalowania w różnych instancjach, za pomocą <b>Instalatora modułów</b>, musisz stworzyć plik .zip, klikając <b>Publikuj</b>.<br/><br/> Możesz budować moduły w paczce etapami i publikować, lub zamieszczać gdy tylko zechcesz. <br/><br/>Po publikacji, lub zamieszczeniu paczki, możesz dalej dokonywać zmian i zmieniać właściwości modułów.  Potem ponownie dokonaj publikacji, lub zamieszczenia, aby zaaprobować zmiany.",
