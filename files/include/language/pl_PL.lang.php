...
//       it is the key for the default case_status_dom value
    ...
    'activity_status_type_dom' => array(''=>'--Brak--',
        'active' => 'Aktywny',
        'inactive' => 'Nieaktywny',
    ),
...
//       it is the key for the default record_type_module value
    ...
    'dom_email_distribution_for_auto_create' => array('roundRobin' => 'Algorytm karuzelowy (Round-Robin)',
        'leastBusy' => 'Pierwszy Wolny',
    ),
    'dom_email_errors' => array(1 => 'Podczas Bezpośredniego Przydzielania obiektów należy wybrać tylko jednego użytkownika.',
...
$app_strings = array(
    ...
    'LBL_POWERED_BY_SUGARCRM' => 'Wspierany przez SuiteCRM',
    'LBL_PRINT' => 'Wydruk',
    'LBL_HELP' => 'Pomoc',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_TITLE_ICON' => SugarThemeRegistry::current()->getImage('icon_email_addressbook', '', null, null, '.gif', 'Address Book').' Książka Adresowa',
    ...
    'ERR_EXTERNAL_API_NO_OAUTH_TOKEN' => 'Brakuje OAuth Access Token.',
    ...
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_LABEL_ACCOUNTS_CONTACTS' => 'Dodawanie kontaktów do Listy Targetów',
    ...
    'LBL_CLOSEALL_BUTTON_TITLE' => 'Zamknij Wszystkie',
    ...
    'LBL_DONE_BUTTON_TITLE' => 'Wykonane',
    ...
    'LBL_FILTER_MENU_BY' => 'Filtruj Penu Po',
    'LBL_VCARD' => 'vCard',
    ...
    'LBL_GS_HELP' => 'Pola tego modułu używane wyszukiwaniu są wyświetlane powyżej.  Podświetlony tekst odpowiada wybranym kryteriom wyszukiwania.',
    'LBL_HIDE' => 'Ukryj',
    'LBL_ID' => 'ID',
    'LBL_IMPORT' => 'Importuj',
    ...
    'LBL_OPENALL_BUTTON_TITLE' => 'Otwórz Wszystkie',
    ...
    'LBL_FULL_FORM_BUTTON_TITLE' => 'Wypełnij Formularz',
    ...
    'LBL_SEARCH' => 'Wyszukaj',
    'LBL_SEARCH_TIPS' => 'Naciśnij przycisk wyszukiwania lub kliknij enter aby uzyskać do nich dokładne dopasowanie.',
    'LBL_SEARCH_TIPS_2' => 'Naciśnij przycisk wyszukiwania lub kliknij enter aby uzyskać dokładne dopasowanie do',
    ...
    'LBL_SUGAR_COPYRIGHT_SUB' => '© 2004-2011 SuiteCRM Inc. Wszystkie prawa zastrzeżone.<br />SuiteCRM jest znakiem handlowym SuiteCRM, Inc. Wszystkie inne nazwy firm i produktów mogą być znakami handlowymi odpowiednich firm, z którymi są one powiązane.',
    ...
    'LBL_VIEW_PDF_BUTTON_TITLE' => 'Drukuj w Formacie PDF',
...
"5. Kliknij w aplikacji opcję Importuj z menu Akcje i wybierz plik do przesłania"   ',
    ...
    'MSG_DUPLICATE' => '{0} rekord, który masz zamiar utworzyć może być duplikatem rekordu {0}, który już istnieje. {1} rekordy zawierające podobne nazwy są wymienione poniżej. <br>Kliknij Utwórz {1} aby utworzyć nowy rekord {0}, lub wybierz istniejący rekord {0} z wymienionych poniżej.',
    'MSG_SHOW_DUPLICATES' => '{0} rekord, który masz zamiar utworzyć może być duplikatem rekordu {0}, który już istnieje. {1} rekordy zawierające podobne nazwy są wymienione poniżej. Kliknij Zapisz aby utworzyć nowy rekord {0}, lub kliknij Anuluj aby przerwać tworzenie rekordu {0}.',
    'LBL_EMAIL_TITLE' => 'Email',
    'LBL_EMAIL_OPT_TITLE' => 'nieaktualny adres e-mail',
...
$app_strings['LBL_CREATE_KB_DOCUMENT'] = 'Stwórz artykuł';
...
$app_list_strings['map_relate_type_list']['Accounts'] = 'Kontrahenci';
...
$app_strings['LBL_SUITE_DASHBOARD_ACTIONS'] = 'Działania';
